...
public class PrismaticServiceShould {
    ...
    public void convertUserSharesCorrectly() throws Exception {
        ...
        String json = convertToJson(new Article.ArticleBuilder()
                .addPrismaticShares(new Share.ShareBuilder().setUser(user)
                                                            .setUserShareAction(userShareAction)
                                                            .createShare(),
                        new Share.ShareBuilder().setUser(user)
                                                .setUserShareAction(userShareAction)
                                                .createShare())
                .createArticle());
